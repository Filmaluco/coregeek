        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold"><i class="icon-coin-euro"></i> Dados Orçamento</legend>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-group form-group-feedback form-group-feedback-left">
                                        <input id="valor" style="" name="or_valor" type="number" class="form-control form-control-lg required" placeholder="00.00" disabled>
                    ...
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold"><i class="icon-wrench"></i> Dados Equipamento</legend>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold"><i class="icon-info3"></i> Informação Adicional</legend>
